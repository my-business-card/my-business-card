			...
			return (
				React.createElement("div", {className: 'form'}, 
					React.createElement("form", null, 
						React.createElement("h3", null, this.props.getTitle(this.props, 'Войти')), 
						...
						React.createElement("button", {className: 'btn btn-success', 
								onClick: this.send}, this.props.getButtonTitle(this.props, 'Войти')), 
						React.createElement("button", {
							type: "button", 
	...
	var UserRegisterForm = React.createClass({displayName: "UserRegisterForm",
		...
		render: function () {
			return (
				React.createElement("div", {className: 'form'}, 
					React.createElement("form", null, 
						React.createElement("h3", null, this.props.getTitle(this.props, 'Регистрация')), 
						React.createElement("button", {
							type: "button", 
							className: "btn btn-link absolute top right", 
                        ...
                        this.props.socialButtons, 
						React.createElement("button", {className: 'btn btn-success', 
								onClick: this.send}, this.props.getButtonTitle(this.props, 'Зарегистрироваться'))
					)
				)
			);
		},
	...
	var UserRemindForm = React.createClass({displayName: "UserRemindForm",
		...
		render: function () {
			return (
				React.createElement("div", {className: 'form'}, 
					React.createElement("form", null, 
						React.createElement("h3", null, this.props.getTitle(this.props, 'Забыли пароль?')), 

						React.createElement("div", {className: 'form-group'}, 
							React.createElement("label", null, "Эл. адрес"), 
						...
						React.createElement("button", {className: 'btn btn-primary', 
								onClick: this.send}, this.props.getButtonTitle(this.props, 'Отправить на почту')), 
